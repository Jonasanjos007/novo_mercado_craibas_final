...
type AddresssControllerReturn = {
    ...
    action: {
        SubmitAddres: (FormAddres: Address, setPage?: boolean) => Promise<boolean>;
        ...
        UpdateAddress: (FormAddres: Address, SetPage: boolean) => Promise<boolean>;
...
export const useAddressController = (): AddresssControllerReturn => {
    ...
    const SubmitAddres = async (FormAddres: Address, setPage?: boolean): Promise<boolean> => {
    ...
    const UpdateAddress = async (FormAddres: Address, SetPage: boolean): Promise<boolean> => {
        if (!FormAddres.phone?.trim()) {
            notify.error("Telefone é obrigatório!", "error");
            return false;
        }
